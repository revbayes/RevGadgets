...
We will use the package roxygen2 to document functions. Function documention should occur at the very beginning of the source file. In plotDivRates.R, this documentions appears as: 
```{r, eval = FALSE}
#' Plot Diversification Rates
#'
#' Plots the output of a episodic diversification rate analysis
