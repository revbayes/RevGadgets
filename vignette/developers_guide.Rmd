...
We ask that you follow the style guides of RevBayes: functions should be in camel case (i.e. readTrees()) and parameter names should be in snake case (i.e. root_age). An exception may be
made if the parameter will simply be passed to another function (i.e. check.names in the readTrace()
function is passed to the read.table() function, and the read.table() parameter name is preserved).
