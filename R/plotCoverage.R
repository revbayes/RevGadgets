...
#'
#' # Generate plots for all parameters at once
#' all_plots <- plotSBC(sbc_output)
#'
#' # Save the plot for the 'sigma' parameter
#' ggplot2::ggsave("sigma_sbc.pdf", all_plots$sigma)
#' }
#'
#' @export
#' @import ggplot2
