...
test_that("summarizes continuous correctly", {
  ...
  expect_equal(names(trace_sum[[1]][[1]]), c("mean", "median", "MAP", "quantile_2.5","quantile_97.5"))
  expect_equal(round(trace_sum[[1]][[1]]["mean"], digits = 3), c("mean" = 0.242))
  expect_equal(round(trace_sum[[1]][[1]]["quantile_2.5"], digits = 3), c("quantile_2.5" = 0.226))
  expect_equal(round(trace_sum[[1]][[1]]["quantile_97.5"], digits = 3), c("quantile_97.5" = 0.258))
})
